...
function ProfilePage() {
  ...
  return (
    <div className="info">
      <h3>Your Posts</h3>
      <Button onClick={getAll} className="myButton">
        See Posts
        <br />
      </Button>
      <Button onClick={getByWord} className="myButton">
        See all with word
        <br />
      </Button>
            ...
            posts.map((x, idx) => {
              return (
                <tr key={idx}>
                  ...
                  <td>{x.posted}</td>
                  <td>
                    <Button variant="warning" onClick={startEdit} id={x.id}>
                      Edit
                    </Button>{" "}
                  </td>
                  <td>
                    <Button variant="danger" onClick={deletePost} id={x.id}>
                      Delete
                    </Button>{" "}
                  </td>
                </tr>
